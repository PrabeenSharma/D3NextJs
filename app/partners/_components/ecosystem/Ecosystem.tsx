...
export default function Ecosystem() {
  ...
  const items: ItemType[] = [
      ...
      {
        "name": "InterNetX",
        "category": "Registry / Registrar",
        "image": "/assets/images/InterNetX.png",
        "tag": "Registry / Registrar",
        "description": "Enterprise domain registrar providing comprehensive domain management and automation solutions for over 22M domains."
      }
    ]
